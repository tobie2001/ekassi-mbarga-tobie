...
const Service = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Services | Ekassi Mbarga Tobie</title>
        <meta name="description" content="Découvrez les services de développement web, mobile, design, backend, consulting tech et analytics proposés par Ekassi Mbarga Tobie. Solutions sur mesure, expertise technique, satisfaction garantie." />
        <meta name="keywords" content="services, développement web, développement mobile, design, backend, consulting, analytics, Ekassi Mbarga Tobie, freelance, solutions digitales, création site web, application mobile, UX, UI, API, SEO, support technique" />
        <meta property="og:title" content="Services | Ekassi Mbarga Tobie" />
        <meta property="og:description" content="Des solutions sur mesure pour transformer vos idées en réalité digitale : développement web, mobile, design, backend, consulting, analytics et plus encore." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ekassi-mbarga-tobie.vercel.app/services" />
        <meta property="og:image" content="https://photos.fife.usercontent.google.com/pw/AP1GczM1CDq-Ils6WFDAX31z2iiZHvi_M-8_Z0K8d8FF1HQNTqGCvS6FvQLv=w890-h890-s-no-gm?authuser=0" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Services | Ekassi Mbarga Tobie" />
        <meta name="twitter:description" content="Des solutions digitales sur mesure : web, mobile, design, backend, consulting, analytics." />
        <meta name="twitter:image" content="https://photos.fife.usercontent.google.com/pw/AP1GczM1CDq-Ils6WFDAX31z2iiZHvi_M-8_Z0K8d8FF1HQNTqGCvS6FvQLv=w890-h890-s-no-gm?authuser=0" />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {services.map((service, index) => (
              ...
              >
                ...
                {/* Main Card */}
                <div className={`relative h-full bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-2 border-transparent hover:border-opacity-50 overflow-hidden`}>
