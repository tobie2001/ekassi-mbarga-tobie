...
const Loader = () => {
  ...
  return (
    <>
      {loading && (
        <div className={`fixed inset-0 z-50 flex items-center justify-center transition-opacity duration-300 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0'
          }`}>
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-full">
                  <img
                    ...
                    alt="Loading"
                    className={`h-32 w-32 rounded-full object-cover border-4 border-gray-800 shadow-2xl transition-all duration-500 ${isVisible ? 'scale-100 opacity-100' : 'scale-75 opacity-0'
                      }`}
                    style={{
          ...
          <div className={`absolute bottom-1/4 w-full text-center transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}>
